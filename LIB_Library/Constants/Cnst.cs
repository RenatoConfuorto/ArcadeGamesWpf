...
namespace LIB.Constants
{
    public class Cnst
    {
        ...
        public const string ApplicationSettingsFileName = "GlobalSettings.xml";
        ...
        public static readonly string ApplicationSettingsFilePath = $"{ApplicationFolderDataPath}\\{ApplicationSettingsFileName}";
        #region User Data
